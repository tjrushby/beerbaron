...
import views.ViewAddNewProduct;
...
public class BeerBaronController implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        // setOnCloseRequest for stage to use views.ConfirmBox
        ...
        tfSearchProducts.textProperty().addListener(((observable, oldValue, newValue) -> {
            ...
            if(newValue == "") {
                ...
                // as the list is already sorted from the sql query used in sqlite.DatabaseHelper
        ...
        // tell the CellFactory to use views.ProductListCell instead of the default
