...
public class ConfirmBox {
    ...
    public boolean display(String title, String message) {
        ...
        try {
            ...
            fxmlLoader.setLocation(getClass().getResource("ConfirmBox.fxml"));

            // setControllerFactory so that ConfirmBoxController is instantiated with confirmBoxStage and message
        ...
        // return the value of confirmed from ConfirmBoxController
